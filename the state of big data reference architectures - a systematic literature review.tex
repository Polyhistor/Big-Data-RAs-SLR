...
\begin{longtable}{ |p{0.5cm}|p{6.5cm}|p{1.5cm}|p{0.8cm}| }
    ...
    \hline
    s9 & Defining architecture components of the Big Data Ecosystem (\cite{demchenko2014defining}) & Academia  &  2014   \\
    \hline

    s10 & Accelerating Secondary Genome Analysis Using Intel Big Data Reference Architecture. (\cite{SikoraWohlfeld2014}) & Practice  &  2014  \\
    \hline

    s11 & Big Data driven e-commerce architecture (\cite{ghandour2015big}) & Academia  &  2015   \\
    \hline
    s12 & The solid architecture for real-time management of big semantic data; Solid architecture (\cite{martinez2015solid}) & Academia  &  2015   \\
    \hline
    s13 & Reference architecture and classification of technologies, products and services for big data systems (\cite{paakkonen2015reference}) & Academia  &  2015   \\
    \hline
    s14 & A Reference Architecture for Big Data Systems (\cite{sang2016reference}) & Academia  &  2016   \\
    \hline
    s15 &  SAP - NEC Reference Architecture for SAP HANA \& Hadoop (\cite{SAPRA}) & Practice  &  2016   \\
    \hline
    s16 & Big data architecture for construction waste analytics (CWA): A conceptual framework (\cite{bilal2016big}) & Academia  &  2016   \\
    \hline
    s17 & A reference architecture for Big Data systems in the national security domain (\cite{Klein}) & Academia  &  2016   \\
    \hline
    s18 & A Reference Architecture for Supporting Secure Big Data Analytics over Cloud-Enabled Relational Databases (\cite{cuzzocrea2016reference}) & Academia  &  2016   \\
    \hline
    s19 & Managing Cloud-Based Big Data Platforms: A Reference Architecture and Cost Perspective (\cite{heilig2017managing}) & Academia  &  2017   \\
    \hline
    s20 & Scalable data store and analytic platform for real-time monitoring of data-intensive scientific infrastructure (\cite{suthakar2017scalable}) & Academia  &  2017   \\
    \hline
    s21 & A software reference architecture for semantic-aware Big Data systems; Bolster Architecture (\cite{Nadal}) & Academia  &  2017   \\
    \hline
    s22 & Simplifying big data analytics systems with a reference architecture (\cite{sang2017simplifying}) & Academia  &  2017   \\
    \hline
    s23 & NIST Big Data interoperability framework (\cite{Chang}) & Practice  &  2018  \\
    \hline
    s24 & Towards a secure, distributed, and reliable cloud-based reference architecture for Big Data in smart cities (\cite{Kohler})  & Academia & 2019   \\
    \hline
    s25 & Reference Architectures and Standards for the Internet of Things and Big Data in Smart Manufacturing (\cite{unal2019reference})  & Academia &  2019   \\
    \hline
    s26 & Reference Architectures and Standards for the Internet of Things and Big Data in Smart Manufacturing (\cite{unal2019reference})  & Academia & 2019   \\
    \hline
    s27 & An integrated GIS platform architecture for spatiotemporal big data (\cite{wang2019integrated})  & Academia & 2019   \\
    \hline
    s28 & Developing a government enterprise architecture framework to support the requirements of big and open linked data with the use of cloud computing (\cite{wang2019integrated})  & Academia & 2019   \\
    \hline
    s29 & Architectural Tactics for Big Data Cybersecurity Analytics Systems: A Review (\cite{ullah2019architectural})  & Academia & 2019   \\
    \hline
   s30 & Video Big Data Analytics in the Cloud: A Reference Architecture, Survey, Opportunities, and Open Research Issues (\cite{alam2020video})  & Academia & 2020   \\
    \hline
    s31 & Extending reference architecture of big data systems towards machine learning in edge computing environments (\cite{paakkonen2020extending})  & Academia & 2020   \\
    \hline
    s32 & A Big Data Reference Architecture for Emergency Management (\cite{iglesias2020big})  & Academia & 2020   \\
    \hline
    s33 & Smart Transportation: A Reference Architecture for Big Data Analytics (\cite{castellanos2021smart})  & Academia & 2020   \\
    \hline
    s36 & ISO/IEC 20547-3:2020 BS ISO/IEC 20547 3:2020 Information technology. Big data reference architecture. Reference architecture (\cite{ISO20547}) & Practice  &  2020  \\
    \hline
    s34 & Phi: A Generic Microservices-Based Big Data Architecture (\cite{maamouri2021phi})  & Academia & 2021   \\
    \hline
    s35 & NeoMycelia: A software reference architecturefor big data systems (\cite{AtaeiApsec})  & Academia & 2021   \\
    \hline
    s36 & Smart teledentistry healthcare architecture for medical big data analysis using IoT-enabled environment (\cite{babar2022smart})  & Academia & 2022   \\
    \hline
    \caption{BD RAs}
    \label{table:bdRAs}
\end{longtable}
...
\begin{table}[h!]
    \begin{tabular}{ |p{0.5cm}|p{3cm}|p{7.5cm}| }
        ...
        \hline
        S9 & Data Source, Real-Time Layer, Serving Layer  & Kappa is perhaps the predecessor of Lambda, aiming to address some of the limitations of it. The major different between Kappa and Lambda is that Kappa has a unified processing layer for batch and stream process, which eliminates the complexity of maintaining two separate systems, reduces costs, and can potentially increase data quality. Nevertheless, this architecture, does not discuss metadata, security, privacy, data quality, and maintainability in details.  \\
        \hline
        % \hline
    \end{tabular}
    \end{table}
...
%     \hline
%     RA & Volume & Variety & Velocity & Metadata Management & Data quality & Data variability & Maintainability & security \& privacy  \\ 
%     \hline
%     % S1 & Streaming layer, batch layer, serving layer & to handle both real-time and batch data  \\ One of pioneers of BD architectures, and perhaps the oldest one, does not address data quality issue, does not address seem to address changes in landscape of data, does not  \\
%     S1 & 1 & 1 & 1 & 1 & 1 & 1 & 1 & 1  \\
%     \hline
%     % \hline
% \end{tabular}
