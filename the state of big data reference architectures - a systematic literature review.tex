...
Stage 1 of screening started with assessing the title, abstract, and keywords of the pooled studies. For grey literatures simply the title. Disagreement among researchers are resolved using Krippendorff’s alpha (\cite{krippendorff2011computing}). Our aim was not to involve in a very complicated statistics model, so we've done most of the computations using SPSS, specifically with premade SAS macros. Our \begin{equation} \alpha \end{equation} value was within the acceptable range, and any disagreement was solved by inviting a third person or a moderator. 
