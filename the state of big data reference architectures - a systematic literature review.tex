...
Nevertheless, the challenge is that our study includes a large number of different study types that needs to go through a single checklist. To address this, we used the GRADE system as discussed by Dyba et al (\cite{dybaa2008strength}). We employed GRADE's basic components of study design, study quality, consistency and directness to measure the overall quality of the evidence pooled. 
