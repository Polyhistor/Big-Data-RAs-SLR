...
\begin{tabular}{ |p{0.5cm}|p{5cm}|p{3cm}|p{0.8cm}| }
    \hline
    \textbf{No.} & \textbf{Title} & \textbf{Domain} & \textbf{Year} \\
    \hline
    1 & Towards a big Data reference architecture (\cite{Maier}) & Academia  &  2013   \\
    \hline
    2 & A reference architecture for Big Data solutions introducing a model to perform predictive analytics using Big Data technology (\cite{geerdink2013reference}) & Academia  &  2013   \\
    \hline
    3 & A proposal for a reference architecture for long-term archiving, preservation, and retrieval of Big Data (\cite{viana2014proposal}) & Academia  &  2014   \\
    \hline
    4 & Questioning the Lambda architecture; Kappa Architecture  (\cite{kreps2014questioning}) & Academia  &  2014   \\
    \hline
    5 & Defining architecture components of the Big Data Ecosystem (\cite{demchenko2014defining}) & Academia  &  2014   \\
    \hline
    6 & Big Data driven e-commerce architecture (\cite{ghandour2015big}) & Academia  &  2015   \\
    \hline
    7 & The solid architecture for real-time management of big semantic data; Solid architecture (\cite{martinez2015solid}) & Academia  &  2015   \\
    \hline
    8 & Reference architecture and classification of technologies, products and services for big data systems  (\cite{paakkonen2015reference}) & Academia  &  2015   \\
    \hline
